...
SKIP_FIREWALL=1 MONITOR_IP="$MONITOR_IP" "$SCRIPT_DIR/install-node-exporter.sh"
echo "Node Exporter actualizado y validado; las reglas de firewall existentes se conservaron."
